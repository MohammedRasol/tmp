...
while($row1=mysqli_fetch_assoc($res)){
	$data[]=array($row1['ID'],$row1['name'],$row1['phone'],$row1['barthdate'],$row1['date']);}
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="w3-sidebar w3-bar-block sidebar">
	...
	<form action="request.php" method="post">
		...
		<td><center><span  class="a">تاريخ الميلاد</span></center></td>
		...
		foreach ($data as $value) {
			echo"<tr>";
			echo"<td><span class='a'><button type='submit' name='requestid' value='$value[0]'class='w3-button w3-btn 'style='width: 100%; border-radius: 12%; margin-top: 5%; margin-left: 33%; background: white ;' >عرض الطلب</button></td>";
		...
		?>
		<div class="bt">
			<a href="ameeen.php" ><button type="button" class="w3-button w3-btn " style="border-radius: 10%; background: white ;" > الرجوع  </button></a>
		</div>
	</form>
	<?php echo $foot;?>
</body>
