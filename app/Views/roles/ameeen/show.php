	...
	<form action="show1.php" method="post">
		<div  style="">
			<select class="c" style="border:1px;direction: rtl; width:18%; margin-left: 33%; margin-top: 5%;" name="fuint" required>
				...
				<option value="6">جميع الوحد</option>
			</select>
		</div>
		<button type="submit" class="w3-button w3-btn " style="width: 10%; border-radius: 12%; margin-top: 5%; margin-left: 33%; background: white ;" >عرض</button>
