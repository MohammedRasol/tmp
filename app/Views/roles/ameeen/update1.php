...
$picture="../pic/".$picture;
$unit=$A[$_POST['fuint']];
$sql="SELECT Name, LogINID,Type FROM user WHERE Unit='$unit'";
...
<div class="w3-sidebar w3-bar-block sidebar">
	...
	<form action="update2.php" method="post">
		<?php
			...
			echo"<tr>
			<td></td>
			<td><span class='a'><center>الاسم</center></span></td>
			<td><center><span class='a'>رقم العضو</center></span></td>
			<td><center><span class='a'>الحالة</center></span></td>
			</tr>";
			foreach ($data as $value) {
				echo"<tr>";
				echo"<td><center><span class='a'><button type='submit' name='Up1' value='$value[1]'class='w3-button w3-btn 'style='width: 100%; border-radius: 12%; margin-top: 5%; margin-left: 33%; background: white ;' > تعديل </button></center></td>";
		...
		?>
		<div class="bt">
			<a href="update.php" ><button type="button" class="w3-button w3-btn " style="border-radius: 10%;background: white ;" > الرجوع  </button></a>
		</div>
	</form>
	<?php echo $foot;?>
	</body>
