...
$sql="SELECT ID,Type FROM user WHERE LogINID=$user";
$result=mysqli_query($db,$sql);
$row=mysqli_fetch_assoc($result);
$ID=$row["ID"];
$type=$row["Type"];
include("../$type/sidebar.php");
...
<div class="w3-sidebar w3-bar-block sidebar">
	...
	<img src="../../img/c.png" class="imgg">
		<form action="" method="post"	>
			...
			<button class="w3-button w3-btn" type="submit" name="x"  style="margin-top: 0.5%; border-radius: 10%;background: white ; margin-left: 39%;"> حفظ </button>
			<a href="ameeen.php"><button type="button" class="w3-button w3-btn " style="margin-top: 0.5%;border-radius: 10%; background: white ;" > الغاء </button></a>
	</form>
	<?php echo $foot;?>
	<?php
		if($_SERVER["REQUEST_METHOD"] == "POST"){
